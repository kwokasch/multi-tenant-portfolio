      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative group">
            ...
            {/* Glow effect */}
            <div className="absolute -inset-4 bg-emerald-500/10 rounded-3xl blur-2xl -z-30 group-hover:bg-emerald-500/20 transition-colors duration-500" />
          </div>
          ...
          <div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-emerald-900/50 flex items-center justify-center flex-shrink-0 mt-1">
            ...
            <a
              ...
              className="inline-flex items-center gap-3 px-6 py-3 bg-emerald-500 hover:bg-emerald-400 text-zinc-900 font-semibold rounded-lg transition-colors"
            >
