    ...
    <section className="px-6 pt-20">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-16 bg-slate-800/50 border border-slate-700 rounded-xl p-8 text-center">
          <div className="flex align-middle text-center justify-center pb-4">
            <div className="text-2xl hover:animate-bounce cursor-default mx-2">🦔</div>
            <h3 className="text-xl font-bold self-end">Let&apos;s Connect</h3>
            <div className="text-2xl hover:animate-bounce cursor-default mx-2">🦔</div>
          </div>
          <p className="text-slate-400 mb-6  mx-auto">
            Interested in working together or just want to chat about tech, geology, or career transitions? I&apos;d love to hear from you.
          </p>
