        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative group">
            <div className="bg-stone-800 border border-stone-700 rounded-2xl p-8 shadow-2xl">
              <div className="aspect-[8.5/11] relative bg-white rounded-lg overflow-hidden shadow-inner">
                <div className="absolute inset-0 bg-gradient-to-b from-stone-100 to-stone-200 flex flex-col items-center justify-center p-8 text-center">
                  <div className="text-stone-400 text-xs uppercase tracking-widest mb-4">
                    Master&apos;s Thesis
                  </div>
                  <h3 className="text-stone-800 text-lg font-serif leading-tight mb-6">
              ...
              <div className="absolute -bottom-2 left-4 right-4 h-4 bg-stone-700 rounded-b-xl -z-10" />
              <div className="absolute -bottom-4 left-8 right-8 h-4 bg-stone-600 rounded-b-xl -z-20" />
            </div>
            {/* Glow effect */}
            <div className="absolute -inset-4 bg-amber-500/10 rounded-3xl blur-2xl -z-30 group-hover:bg-amber-500/20 transition-colors duration-500" />
          </div>
          ...
          <div>
            ...
            <h2 className="text-4xl font-bold mb-6">
              Master&apos;s <span className="text-amber-500">Thesis</span>
            </h2>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-amber-900/50 flex items-center justify-center flex-shrink-0 mt-1">
                  <span className="text-amber-500 text-xs">1</span>
                </div>
            ...
            <a
              ...
              className="inline-flex items-center gap-3 px-6 py-3 bg-amber-600 hover:bg-amber-500 text-stone-900 font-semibold rounded-lg transition-colors"
            >
