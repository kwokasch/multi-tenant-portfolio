      ...
      <div className="max-w-6xl mx-auto relative w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div
              className={`flex flex-col sm:flex-row flex-wrap gap-3 transition-all duration-700 delay-[400ms] ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}
            >
              <a
                href="/projects"
                className="px-4 py-3 bg-orange-500 hover:bg-orange-400 text-sm text-slate-900 font-semibold rounded-lg transition-all hover:shadow-lg hover:shadow-orange-500/25"
              >
                My Projects
              </a>
              <a
                ...
                className="px-4 py-3 border border-slate-600 hover:border-orange-500 text-sm text-slate-300 hover:text-orange-500 rounded-lg transition-colors flex items-center gap-2"
              >
